...
WebUI.openBrowser('http://crmiis:8085')
...
WebUI.sendKeys(findTestObject('Page_CrearSSSComp - Mesa de Servicios/input_Solicitante (email)_SolicitanteEmail'), Keys.chord(Keys.DOWN, Keys.ENTER))

WebUI.selectOptionByValue(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_Seleccione EmpresaAlmagroCSCICSAICSA_768436'), '13', true)
...
WebUI.selectOptionByValue(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_AgendadaAsignadaEn ProcesoEscaladaEs_419e8d'), '8', true)

WebUI.click(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_Seleccione TipoApoyo TcnicoCadaCada _05c53f'))

WebUI.selectOptionByValue(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_Seleccione TipoApoyo TcnicoCadaCada _05c53f'), '4', true)

WebUI.click(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_Seleccione CategoraAntivirusAplicaci_c5a911'))

WebUI.selectOptionByValue(findTestObject('Page_CrearSSSComp - Mesa de Servicios/select_Seleccione CategoraAntivirusAplicaci_c5a911'), '26', true)
